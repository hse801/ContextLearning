...
from dataset import thyroid_dataloader
from dataset import lung_dataloader
...
class Engine(object):
    ...
    def get_train_loader(self):
        ...
        #     is_shuffle = False
        # train_loader, _, _ = thyroid_dataloader.generate_thyroid_dataset()
        train_loader, _, _ = lung_dataloader.generate_lung_dataset()
    ...
    def get_test_loader(self):
        ...
        #         test_dataset)
        #     batch_size = self.args.batch_size // self.world_size
        # _, test_loader, _ = thyroid_dataloader.generate_thyroid_dataset()
        _, test_loader, _ = lung_dataloader.generate_lung_dataset()
